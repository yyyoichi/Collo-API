...
type RequestConfig struct {
	...
	UseNdlCache       bool                        `protobuf:"varint,9,opt,name=use_ndl_cache,json=useNdlCache,proto3" json:"use_ndl_cache,omitempty"`                                               // apiフェッチ時cacheを利用するか。デフォルトは使用しない。
	CreateNdlCache    bool                        `protobuf:"varint,10,opt,name=create_ndl_cache,json=createNdlCache,proto3" json:"create_ndl_cache,omitempty"`                                     // apiフェッチ後、cacheを作成するか
	NdlCacheDir       string                      `protobuf:"bytes,11,opt,name=ndl_cache_dir,json=ndlCacheDir,proto3" json:"ndl_cache_dir,omitempty"`                                               // apiフェッチのキャッシュ利用場所
}
...
func (x *RequestConfig) GetUseNdlCache() bool {
	if x != nil {
		return x.UseNdlCache
	}
	return false
}

func (x *RequestConfig) GetCreateNdlCache() bool {
	if x != nil {
		return x.CreateNdlCache
	}
	return false
}

func (x *RequestConfig) GetNdlCacheDir() string {
	if x != nil {
		return x.NdlCacheDir
	}
	return ""
}
...
var file_api_v3_collo_proto_rawDesc = []byte{
	...
	0x6f, 0x63, 0x65, 0x73, 0x73, 0x22, 0xda, 0x05, 0x0a, 0x0d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	,
